...
class GroqLLM(LLM):
    ...
    client: Any = Field(default_factory=lambda: Groq(api_key=os.getenv("GROQ_API_KEY")))  # Unified API Key
    model_name: str = "llama3-70b-8192"
    department: str = "General"
    
    def __init__(self, **data):
        super().__init__(**data)
        self.client = Groq(api_key=os.getenv("GROQ_API_KEY"))  # Unified API Key
